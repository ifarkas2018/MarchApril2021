...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            userName = userName.trim(); // removes the empty space from the begining and end of the string
            ...
            password = password.trim(); // removes the empty space from the begining and end of the string
