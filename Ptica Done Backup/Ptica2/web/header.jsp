                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                    ...
                    <nav class="navbar navbar-expand-md navbar-light bg-light">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="DodajVarSesije" onclick="kolacicPopunjeno('NoviNalog')">Srpski</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="DodajVarSesije" onclick="kolacicPopunjeno('NoviNalog')">Engleski</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="DodajVarSesije" onclick="kolacicPopunjeno('NoviNalog')">Nemački</a>
                            </li>
                        </ul>
                    </nav>
                </div>
